...
@property (nonatomic, strong) NSArray *backColor;
...
- (instancetype)initWithImages:(NSArray *)images selectedIndices:(NSIndexSet *)selectedIndices borderColors:(NSArray *)colors andBackColor:(NSArray*)color{
    if (self = [super init]) {
        _isSingleSelect = NO;
...
- (instancetype)initWithImages:(NSArray *)images selectedIndices:(NSIndexSet *)selectedIndices {
    return [self initWithImages:images selectedIndices:selectedIndices borderColors:nil andBackColor:self.backColor];
}

- (instancetype)initWithImages:(NSArray *)images {
    return [self initWithImages:images selectedIndices:nil borderColors:nil andBackColor:self.backColor];
}
