...
- (CDSideBarController*)initWithImages:(NSArray*)images withTitleArray:(NSArray*)title
{
    ...
    for (UIImage *image in [images copy])
    {
        ...
        button.frame = CGRectMake(5, 50 + (80 * index), 80, 80);
        button.tag = index;
        [button setTitle:title[index] forState:UIControlStateNormal];
        ...
        button.imageEdgeInsets = UIEdgeInsetsMake(
                                                  0,10,20,10);
        button.titleEdgeInsets = UIEdgeInsetsMake(0,-200,-54,-8
                                                  );
...
//    [view addGestureRecognizer:singleTap];
    ...
    _backgroundMenuView.backgroundColor = [[UIColor blackColor]colorWithAlphaComponent:.5];
